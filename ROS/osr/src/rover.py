...
class Rover(object):
	...
	rospy.logdebug_throttle(1, "Code wird ausgefuehrt")
	...
	#rospy.Subsriber("/encoder", JointState, self.play_music)
    ...
    def play_music(self, music_file = "/home/ubuntu/police_s.wav", volume = 0.8):
        #set up the mixer
